...
if (in_array('niso-carousel-pro/niso-carousel-pro.php', $active_plugins)) {
	esc_html_e('Please deactive Niso Carousel Free Version First Then Try Again.', 'niso');
	exit;
}

define('NISO_CAROUSEL_VERSION', '1.3.20');
...
if (!function_exists('niso_slider_carousel_style_script')) :
	function niso_slider_carousel_style_script()
	{
		...
		wp_enqueue_style('niso-animate', plugins_url('/assets/css/animate.css', __FILE__), array(), NISO_CAROUSEL_VERSION, 'all');
		wp_enqueue_style('niso-carousel', plugins_url('/assets/css/niso-carousel.css', __FILE__), array(), NISO_CAROUSEL_VERSION, 'all');
